...
```
The boundary is given by `r summ2.intercept` + `r summ2.b1`\*AGE + `r summ2.b2`\*SEX + `r summ2.b3`\*SBP + `r summ2.b4`\*CHOL +  `r summ2.b5`\*FRW + `r summ2.b6`\*CIG + $\geq$ `r prob1.logit`
