...
sample100 <- iq_data[sample(1:nrow(iq_data), 100,
  	replace=FALSE),c("Coding","Auto","Mechanic","Elec","Science","Math", "Arith", "Word", "Parag", "Numer")] #"AFQT" I think this should be removed????
```
...
```{r}
cpve.asvab.all <- 100*cumsum((pc.asvab.all$sdev)^2)/11  #10??? 
